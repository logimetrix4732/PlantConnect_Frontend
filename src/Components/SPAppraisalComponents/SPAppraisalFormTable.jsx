...
export default function SPAppraisalFormTable({
  ...
  const district = ["MOKOKCHUNG", "TUENSANG"];
  return (
    <React.Fragment>
      <Dialog
        ...
        {data.length ? (
          <DialogContent>
            {data?.map((categoryObj, index) => (
              <Accordion
                key={index}
                defaultExpanded={categoryObj?.quarter_enabled}
              >
                <AccordionSummary
                            ...
                            {loading ? (
                              ...
                              categoryObj.tabledata
                                ...
                                .map((row, ind) => {
                                  ...
                                  const rowData = activityTableData.find(
                                    (entry) =>
                                      entry.activity_id === row.activity_id &&
                                      entry.activity === row.activity &&
                                      entry.quarter_id === row.quarter_id
                                  );
                        ...
                        <Grid container spacing={1} alignItems="center">
                          ...
                          {userRole == "SP" && (
                            ...
                            >
                              <Grid item ml={2}>
                                <Button
                                  onClick={handleCloseSPAppraisalForm}
                                  color="primary"
                                  variant="contained"
                                  style={{
                                    borderRadius: "20px",
                                ...
                                <Button
                                  onClick={() =>
                                    handleSubmitFPOForm("under Progress")
                                  }
                                  color="primary"
                                  variant="contained"
                                  style={{
                          ...
                          {userRole == "DC" && (
                            ...
                            >
                              <Grid item ml={2}>
                                ...
                                <Button
                                  onClick={() => handleSubmitFPOForm("Reject")}
                                  color="primary"
                                  variant="contained"
                                  style={{
                                    borderRadius: "20px",
