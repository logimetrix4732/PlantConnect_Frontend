...
export default function SPFpoTable({
  data,
  lrpTrue,
  loading,
  headCells,
                    ...
                    return (
                      <StyledTableRow key={`fig-table${ind}`}>
                        ...
                        <StyledTableCell
                          ...
                          className={
                            lrpTrue
                              ? "colorCodeTable tableRowNameWidth"
                              : "colorCodeTable"
                          }
                        >
                        ...
                        {lrpTrue ? (
                          <StyledTableCell
                            ...
                            className="colorCodeTable tableRowNameWidth"
                          >
                            {["Processing", "Rejected"].includes(row.Status) ? (
                              <Button
                                className="SP-table-Button"
                                onClick={() => editedFpo(row.id)}
                              >
                                View & Update
                              </Button>
